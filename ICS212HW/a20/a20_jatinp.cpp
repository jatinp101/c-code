...
int main (void) {
  ...
  c1.print();
  cout << endl << "Complex number c2 using copy constructor is : ";
  c2.print();

  cout << endl  << "Testing add() function" << endl;
  c3 = c1.add(c2);
  c1.print();
  cout << " + ";
  c2.print();
  ...
  cout << endl << endl  << "Testing subtract() function" << endl;
  c3 = c1.subtract(c2);
  c1.print();
  cout << " - ";
  c2.print();
  ...
  cout << endl << endl  << "Testing multiply() function" << endl;
  c3 = c1.multiply(c2);
  c1.print();
  cout << " * ";
  c2.print();
  ...
  cout << endl << endl  << "Testing divide() function" << endl;
  c3 = c1.divide(c2);
  c1.print();
  cout << " / ";
  c2.print();
